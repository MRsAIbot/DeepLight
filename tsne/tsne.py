...
def tsne(X = Math.array([]), no_dims = 2, initial_dims = 50, perplexity = 30.0, num_iters=1000):
...
if __name__ == "__main__":
	...
	Y = tsne(X, 2, 50, 20.0, num_iters=int(iters))
	time_str = time.strftime("_%m-%d-%H-%M_", time.gmtime())
	with open('tsne'+ iters + '_' + time_str +'.pkl', 'wb') as f:
		cPickle.dump(Y, f, -1)
